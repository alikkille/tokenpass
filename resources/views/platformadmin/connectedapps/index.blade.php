      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            {{-- inline delete form --}}
            <form onsubmit="return confirm('Are you sure you want to delete this balance?')" action="{{ route('platform.admin.connectedapps.destroy', ['id' => $model['id']]) }}" method="POST" style="margin-bottom: 0; display: inline;">
