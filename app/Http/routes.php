...
Route::post('api/v1/tca/provisional/tx', array('as' => 'api.tca.provisional.tx', 'uses' => 'API\APIController@registerProvisionalTCATransaction'));
...
Route::post('_xchain_client_receive', array('as' => 'xchain.receive', 'XChain\XChainWebhookController@receive'));
